	...
	<header id="masthead">
		...
		<div class="logo">
			...
			if ( has_custom_logo() ) :
				...
				?>
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home"><img alt="Sunrise Movement logo" src="<?php echo esc_url( get_template_directory_uri() . '/images/sm-y.svg' ); ?>"><span class="screen-reader-text"><?php esc_html_e( 'Home', 'susty' ); ?></span></a>
				<?php
			endif;
			?>
		</div>
